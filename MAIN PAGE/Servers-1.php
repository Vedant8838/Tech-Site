      ...
      <body data-home-page="index.php" data-home-page-title="Page 1" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
        ...
        <section class="u-align-left u-clearfix u-section-3" id="block-3">
          <div class="u-clearfix u-sheet u-sheet-1">
            ...
            <li class="u-text u-text-2">Data Pluse Sloutions server solutions address the challenges of an evolving IT environment by delivering leading enterprise-class features and functionality from leading OEMs. We deliver a unique array of options configured to meet the needs of your IT environment in the present and the future. Datapluse’s solution architecture helps you to determine the best course of action for optimized application & system development to align with your needs. Whether you are considering continued growth of business applications, recovery time objectives, high availability and disaster recovery or business continuance, we have solutions for all.  </li>
