  ...
  <body data-home-page="index.php" data-home-page-title="Page 1" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
            ...
            <div class="u-layout-row">
              <div class="u-align-left u-container-align-left u-container-style u-layout-cell u-right-cell u-shape-rectangle u-size-30 u-layout-cell-1" data-animation-name="customAnimationIn" data-animation-duration="1500">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                  <h1 class="u-align-left u-text u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="750">IT Infrastructure </h1>
                  <p class="u-align-left u-text u-text-2">What is IT Infrastructure? - United World TelecomIT infrastructure is the combination of hardware, software, and network components that enable an organization to use technology to support its business. It also includes data storage and security systems.  </p>
                  <a href="#block-3" class="u-active-white u-align-left u-border-2 u-border-active-white u-border-hover-white u-border-white u-btn u-btn-round u-button-style u-hover-white u-palette-1-light-1 u-radius-10 u-text-active-palette-3-base u-text-hover-palette-1-light-1 u-text-white u-btn-1" title="Blog">read more</a>
                </div>
              </div>
    ...
    <section class="u-align-left u-clearfix u-section-3" id="block-3">
      <div class="u-clearfix u-sheet u-sheet-1">
        ...
        <p class="u-text u-text-2"> Data Center technology is improving every day. New servers allow for higher densities than ever before, putting great strains on legacy cooling and power products. In response, corporations need to intelligently allocate resources to get the most from their data center infrastructure. Optimizing your current environment with the right cooling and power infrastructure will help you reclaim precious capacity and may allow you to delay or avoid altogether the time and expense required to build a new data center. Optimizing data center infrastructure can achieve immediate results through increased capacity. In the long run, finding the right infrastructure for your data center can save money through reduced CAPEX and OPEX costs.<br>
