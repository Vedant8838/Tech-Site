    ...
    <link rel="stylesheet" href="index.css" media="screen">
      ...
      <body data-home-page="Page-1.html" data-home-page-title="Page 1" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
                ...
                <div class="u-layout-row">
                  <div class="u-align-left u-container-align-left u-container-style u-layout-cell u-right-cell u-shape-rectangle u-size-30 u-layout-cell-1" data-animation-name="customAnimationIn" data-animation-duration="1500">
                    <div class="u-container-layout u-valign-middle u-container-layout-1">
                      <h1 class="u-align-left u-text u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="750">Network Management System</h1>
                      <p class="u-align-left u-text u-text-2">A "Network Management System (NMS)" refers to a software application or suite of tools that allows network administrators to monitor, configure, and manage the performance of a network infrastructure, including devices like routers, switches, and servers, by collecting data from them and providing a centralized control point to identify and resolve issues, optimize network performance, and maintain overall network health and security; essentially, it's a system that helps manage all aspects of a network from a single interface. </p>
        ...
        <section class="u-align-left u-clearfix u-section-3" id="block-3">
          <div class="u-clearfix u-sheet u-sheet-1">
            <h4 class="u-text u-text-palette-1-base u-text-1">Network Management System</h4>
            <p class="u-text u-text-2"> Most organization’s IT professionals prefer to deploy an efficient NMS solution for unified LAN/WLAN management to transform complex network data into business centric, actionable information and efficiently address regulatory compliance requirements. Today’s business critical network demands a network wide easy policy enforcement system to ensure the availability of network resources for today’s bandwidth intensive applications.<br>
               <h5 class="u-text u-text-palette-1-base u-text-1">Solution Offerings</h5>
            <li class="u-text u-text-2">Our solution provides help in Optimizing Your Network Infrastructure. 
            <li class="u-text u-text-2">  Reduce IT administrative effort with the automation of routine tasks and web-based dashboard.
            <li class="u-text u-text-2"> Highly automated capabilities avoid time-consuming manual tasks for consistency and increased efficiency.
            <li class="u-text u-text-2"> Specialized identity and access management for visibility and control of users’ devices. Streamline management with the integration of wired and wireless networks.
            <li class="u-text u-text-2">Easily enforce policies network-wide for QoS, bandwidth, etc
            <li class="u-text u-text-2">Anytime, anywhere management from popular mobile devices for the fastest response times.
           </li>
            </p>
          </div>
        </section>
