      ...
      <body data-home-page="index.php" data-home-page-title="Page 1" data-path-to-root="./" data-include-products="false" class="u-body u-xl-mode" data-lang="en">
                ...
                <div class="u-layout-row">
                  <div class="u-align-left u-container-align-left u-container-style u-layout-cell u-right-cell u-shape-rectangle u-size-30 u-layout-cell-1" data-animation-name="customAnimationIn" data-animation-duration="1500">
                    <div class="u-container-layout u-valign-middle u-container-layout-1">
                      <h1 class="u-align-left u-text u-text-1" data-animation-name="customAnimationIn" data-animation-duration="1500" data-animation-delay="750">IT Outsourcing</h1>
                      <p class="u-align-left u-text u-text-2">IT outsourcing is a business practice where a company hires an external provider to manage some or all of its IT functions. This can include web development, application maintenance, and IT infrastructure. </p>
        ...
        <p class="u-text u-text-2"> Today Sourcing Lifecycle is a tedious & complex process that requires thorough planning, and rigorous execution control and optimization to enable full value. We at Infoserve have developed outsourcing delivery models that are agile, flexible and exploit best-of-breed expertise & capabilities that foster innovation and growth.
            ...
            <br>
                ...
                <li class="u-text u-text-2">Technical Support
                    - End User Support (FMS including Service Desk)
                    - Post Sales Support
                <li class="u-text u-text-2">Operations Management
                <li class="u-text u-text-2">Staff Augmentation Service
                <li class="u-text u-text-2"> Managed IT
                    – Infra Support (Compute, Networks, UC, S&S Devices, DC)
                    – Applications Support (DB, E-mail, SharePoint)
